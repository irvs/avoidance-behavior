    ...
    class CNOID_EXPORT ColdetModel
    {
      public:
        ...
        */
         ...
         */
        //bool checkCollisionWithPointCloud(const std::vector<Vector3> &i_cloud, double i_radius); //オリジナル
//#define OP

//#ifdef OP
        int checkCollisionWithPointCloud(const std::vector<Vector3> &i_cloud, double i_radius); //①
//#else
        void checkCollisionWithPointCloud2(const std::vector<Vector3> &i_cloud, double i_radius, std::vector<Vector3> &col_result); //②
        void checkCollisionWithPointCloud3(const std::vector<Vector3> &i_cloud, double i_radius, std::vector<int> &judge); //②
//#endif
        void removeCollisionWithPointCloud(std::vector<Vector3> &i_cloud, double i_radius);
        void removeCollisionWithPointCloud2(const std::vector<Vector3> &i_cloud, double i_radius, std::vector<int> &judge);
